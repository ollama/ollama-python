...
def _encode_image(image) -> str:
  ...
  'TUlUIExpY2Vuc2UNCg0KQ29weXJpZ2h0IChjKSBPbGxhbWENCg0KUGVybWlzc2lvbiBpcyBoZXJlYnkgZ3JhbnRlZCwgWy4uLl0= ...'
  ...
  raise RequestError(f'image must be bytes, path-like object, or file-like object, not {type(image).__name__}')
